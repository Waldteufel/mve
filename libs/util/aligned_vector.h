#ifndef MVE_ALIGNED_VECTOR_HEADER
#define MVE_ALIGNED_VECTOR_HEADER
...
typedef std::vector<float, AlignedAllocator<float, 16> > SSEFloatVector;

UTIL_NAMESPACE_END

#endif // MVE_ALIGNED_VECTOR_HEADER
