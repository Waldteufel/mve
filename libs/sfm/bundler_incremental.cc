...
//#define PBA_DISTORTION_TYPE PBA_PROJECTION_DISTORTION
#define PBA_DISTORTION_TYPE PBA_MEASUREMENT_DISTORTION
//#define PBA_DISTORTION_TYPE PBA_NO_DISTORTION
...
Incremental::bundle_adjustment_intern (int single_camera_ba)
{
    ...
    if (single_camera_ba >= 0)
        pba.SetNextBundleMode(BUNDLE_ONLY_MOTION);
    else
        pba.SetNextBundleMode(BUNDLE_FULL);
